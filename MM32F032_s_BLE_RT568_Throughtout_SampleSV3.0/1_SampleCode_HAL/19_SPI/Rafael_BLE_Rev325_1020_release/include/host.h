 ...
 * @{
 */
#define _GATT_HDL_OFFSET_BASE_                          (_GAP_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_GAP)//0x01+0xb
 ...
 */
#define _DIS_HDL_OFFSET_BASE_                           (_GATT_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_GATT)//0x0c+4
...
#else
#define _HRS_HDL_OFFSET_BASE_                           (_DIS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_DIS)//0x10+0x17
...
#else
#define _BAS_HDL_OFFSET_BASE_                           (_HRS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_HRS)//0x27+0
...
#else
#define _HIDS_HDL_OFFSET_BASE_                          (_BAS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_BAS)
#define _HOGP_HDL_OFFSET_BASE_                          (_BAS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_BAS)//0x27+0
...
#else
#define _SCPS_HDL_OFFSET_BASE_                          (_HOGP_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_HIDS)//0x27
...
#else
#define _IAS_HDL_OFFSET_BASE_                           (_SCPS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_SCPS)//0x27
...
#else
#define _LLS_HDL_OFFSET_BASE_                           (_IAS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_IAS)//0x27+0
...
#else
#define _TPS_HDL_OFFSET_BASE_                           (_LLS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_LLS)//0x27
...
#else
#define _BLS_HDL_OFFSET_BASE_                           (_TPS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_TPS)//0x27+0
...
#else
#define _HTS_HDL_OFFSET_BASE_                           (_BLS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_BLS)//0x27
...
#else
#define _RSCS_HDL_OFFSET_BASE_                          (_HTS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_HTS)//0x27
...
#else
#define _CSCS_HDL_OFFSET_BASE_                          (_RSCS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_RSCS)//0x27
...
#else
#define _LNS_HDL_OFFSET_BASE_                           (_CSCS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_CSCS)//0x27+0
...
#else
#define _GLS_HDL_OFFSET_BASE_                           (_LNS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_LNS)//0x27+0
...
#else
#define _CPS_HDL_OFFSET_BASE_                           (_GLS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_GLS)//0x27
...
#define SIZE_ATTRIBUTE_UDF01S_BASE_                     16
#else
#define SIZE_ATTRIBUTE_UDF01S_BASE_                     0
#endif
#define _UDF01S_HDL_OFFSET_BASE_                        (_CPS_HDL_OFFSET_BASE_+SIZE_ATTRIBUTE_CPS)//0x27
/** @} */
