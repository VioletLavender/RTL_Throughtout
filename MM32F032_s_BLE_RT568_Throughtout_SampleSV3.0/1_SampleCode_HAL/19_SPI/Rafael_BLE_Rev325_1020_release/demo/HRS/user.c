...
void Ble_Slave_AdvInit(void)
{
    ...
    setBLE_AdvParam(advParam);				 //SET_ADV_PARA can be modified by user
}
...
void Ble_Master_Init(void)
{
    ...
    connParam.Conn_IntervalMin = CONN_INTERVAL_MIN;
    connParam.Conn_IntervalMax = CONN_INTERVAL_MAX;
