...
struct MHC_Le_Data_Length_Change_Para
{
    ...
    Uint8 HCI_Subevent_Code;
    HCI_CONN_HDL
    Uint8 HCI_MaxTxOctets;
    Uint8 HCI_MaxTxTime;
    Uint8 HCI_MaxRxOctets;
    Uint8 HCI_MaxRxTime;
    Uint8 HCI_ResvMem[(MAX_MBLK_SIZE-6-SIZE_HCI_CONN_HDL-SIZE_MHC_HCI_HW_PKT_TYPE)];
};
...
extern MBLK *GetMsgBlk_wSize_Isr(Uint8 len);
