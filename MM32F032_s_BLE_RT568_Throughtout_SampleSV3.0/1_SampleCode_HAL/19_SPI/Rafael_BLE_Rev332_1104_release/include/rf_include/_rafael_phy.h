...
#define MAX_TXPOWER_REGSTTING_LEN                5
...
#define RF_CCM_RxDecrResultChk()    ((SPI_1BYT_SetRx_Isr(RFIP_REG_155)&REG_155_MIC_OK))       //0: Fail, No 
...
extern uint8_t RF_Set_TxPowerLevel_Isr(Uint8 *power);
