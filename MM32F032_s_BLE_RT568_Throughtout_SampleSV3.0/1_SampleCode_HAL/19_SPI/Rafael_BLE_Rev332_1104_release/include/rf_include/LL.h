...
#include "_rafael_phy.h" // MAX_TXPOWER_REGSTTING_LEN
...
typedef struct Adv_Param
{
    ...
    Uint8 LL_Tx_PowerLevel[MAX_TXPOWER_REGSTTING_LEN];        //addr: 02
...
typedef struct LE_Set_Scan_Para
{
    ...
    Uint8 LL_Tx_PowerLevel[MAX_TXPOWER_REGSTTING_LEN];      //addr: 0A
} LE_Set_Scan_Para;
...
typedef struct LE_Conn_Para
{
    ...
    Uint8 LL_Tx_PowerLevel[MAX_TXPOWER_REGSTTING_LEN];      //addr: 03
...
struct LE_Init_Para
{
    ...
    Uint8 LL_Tx_PowerLevel[MAX_TXPOWER_REGSTTING_LEN];     //addr: 11
...
#define LEN_LE_INIT_PARA        (1*5+2*8+LEN_BD_ADDR+MAX_TXPOWER_REGSTTING_LEN)   //From LL_LE_Scan_Interval
