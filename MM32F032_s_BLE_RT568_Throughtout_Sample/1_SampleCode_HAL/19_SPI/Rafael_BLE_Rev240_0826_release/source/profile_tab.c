...
const Uint8 ATT_HDL_GAP_CHARACTERISTIC_DEVICE_NAME[] =                                         //Mandatory
{
    ...
    (
        ...
        GATT_DECLARATIONS_PROPERTIES_READ |													//0x0a
    ...
    (_GAP_HDL_OFFSET_BASE_+2), 0x00,																//0x03
...
{
    0x00, _DIS_HDL_OFFSET_BASE_,                                 												//0x00  _DIS_HDL_OFFSET_BASE_=0x15 		//Handle
...
const Uint8 ATT_HDL_DIS_CHARACTERISTIC_SERIAL_NUMBER_STRING[] =                                     													//Optional¿ÉÑ¡ÔñµÄ
{
    0x00, (_DIS_HDL_OFFSET_BASE_+1),                              											//0x00		0x16                        //Handle
    ...
    (_DIS_HDL_OFFSET_BASE_+2), 0x00,																										//0x17   	0x00
...
{
    0x00, (_DIS_HDL_OFFSET_BASE_+2),                                                  	//0x00    0x17          							//Handle
    GATT_SPEC_CHARACTERISTIC, GATT_SPEC_CHARACTERISTIC_SERIAL_NUMBER_STRING,           	//0x2a		0x25             						//Attribute Type
...
{
    0x01, (_OTA_HDL_OFFSET_BASE_+5),                                                                //Handle
    GATT_DECLARATIONS, GATT_DECLARATIONS_CHARACTERISTIC,                                            //Attribute Type
    SIZE_OF_ATTRIBUTE_VALUE_5,
    //0x11,
    (
...
void (* const ATT_Write[])(uint8_t connID, uint8_t length, uint8_t *srcCMD) =
{
    ...
    ATT_HDL_Wr_NULL,                                                    //ATT_HDL_OTA_OTA_DATA_INIT,
    ...
    ATT_HDL_Wr_NULL,                                                    //ATT_HDL_OTA_OTA_CMD_CONTROL_POINT_INIT,
